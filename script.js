...
function calculateNumerology() {
  ...
  document.getElementById('expressionNumber').innerText = expressionNumber;
  document.getElementById('soulUrgeNumber').innerText = soulUrgeNumber;
  document.getElementById('attitudeNumber').innerText = attitudeNumber;
  document.getElementById('personalityNumber').innerText = personalityNumber;
  document.getElementById('destinyNumber').innerText = destinyNumber;
  document.getElementById('balanceNumber').innerText = balanceNumber;
  document.getElementById('coreStrengthNumber').innerText = coreStrengthNumber;
  document.getElementById('personalYearNumber').innerText = personalYearNumber;
  document.getElementById('lessonDebt').innerText = lessonDebt;
  document.getElementById('karmicDebtNumber').innerText = karmicDebtNumbers;
}

// Event listener cho nút bấm
